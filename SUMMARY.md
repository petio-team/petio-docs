...
* [Docker](install-guides/docker.md)
...
* [FreeBSD](install-guides/freebsd.md)
* [MacOS](install-guides/macos.md)
* [UnRAID](install-guides/unraid.md)
* [Windows](install-guides/windows.md)

## Configuration

* [First Time Setup](configuration/first-time-setup.md)
* [General Settings](configuration/general-settings.md)
* [Radarr](configuration/radarr.md)
* [Sonarr](configuration/sonarr-1.md)
